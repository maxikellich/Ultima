...
var _hoisted_1 = ["id", "aria-label", "aria-disabled", "aria-expanded", "aria-haspopup", "aria-level", "aria-setsize", "aria-posinset"];
...
function render$1(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createBlock(Transition, {
    ...
    default: withCtx(() => [
      ($props.root ? true : $props.visible) ? (openBlock(), createElementBlock("ul", mergeProps({
        key: 0,
        ref: "container"
      }, _ctx.ptm("menu")), [
        (openBlock(true), createElementBlock(Fragment, null, renderList($props.items, (processedItem, index) => {
          return openBlock(), createElementBlock(Fragment, {
            ...
            $options.isItemVisible(processedItem) && !$options.getItemProp(processedItem, "separator") ? (openBlock(), createElementBlock("li", mergeProps({
                ...
                !$props.templates.item ? (openBlock(), createElementBlock(Fragment, { key: 0 }, [
                  $options.getItemProp(processedItem, "to") && !$options.isItemDisabled(processedItem) ? (openBlock(), createBlock(_component_router_link, {
                    ...
                    $options.getItemProp(processedItem, "items") ? (openBlock(), createElementBlock(Fragment, { key: 2 }, [
                      ...
                      }, null, 8, ["active"])) : (openBlock(), createBlock(_component_AngleRightIcon, mergeProps({
                        key: 1,
                        class: "p-submenu-icon"
              ...
              }, null, 8, ["id", "menuId", "focusedItemId", "items", "templates", "activeItemPath", "exact", "level", "pt", "visible"])) : createCommentVNode("", true)
