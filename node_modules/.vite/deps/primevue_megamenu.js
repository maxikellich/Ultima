import {
  script as script3
} from "./chunk-JTFDMLPG.js";
import {
  script as script2
} from "./chunk-WXSS6TNA.js";
import {
  Ripple
...
function render$1(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock("ul", normalizeProps(guardReactiveProps(_ctx.ptm("menu"))), [
    $props.submenu ? (openBlock(), createElementBlock("li", mergeProps({
      key: 0,
      class: $options.getSubmenuHeaderClass($props.submenu),
      style: $options.getItemProp($props.submenu, "style"),
      role: "presentation"
    }, _ctx.ptm("submenuHeader")), toDisplayString($options.getItemLabel($props.submenu)), 17)) : createCommentVNode("", true),
    (openBlock(true), createElementBlock(Fragment, null, renderList($props.items, (processedItem, index) => {
      return openBlock(), createElementBlock(Fragment, {
        ...
        $options.isItemVisible(processedItem) && !$options.getItemProp(processedItem, "separator") ? (openBlock(), createElementBlock("li", mergeProps({
            ...
            !$props.templates.item ? (openBlock(), createElementBlock(Fragment, { key: 0 }, [
              $options.getItemProp(processedItem, "to") && !$options.isItemDisabled(processedItem) ? (openBlock(), createBlock(_component_router_link, {
                ...
                $options.isItemGroup(processedItem) ? (openBlock(), createElementBlock(Fragment, { key: 2 }, [
                  ...
                  }, $options.getPTOptions(processedItem, "submenuIcon")), null, 16, ["active"])) : (openBlock(), createBlock(resolveDynamicComponent($props.horizontal ? "AngleDownIcon" : "AngleRightIcon"), mergeProps({
                    key: 1,
                    class: "p-submenu-icon"
          ...
          $options.isItemVisible(processedItem) && $options.isItemGroup(processedItem) ? (openBlock(), createElementBlock("div", mergeProps({
            key: 0,
            class: "p-megamenu-panel"
          }, _ctx.ptm("panel")), [
            createBaseVNode("div", mergeProps({ class: "p-megamenu-grid" }, _ctx.ptm("grid")), [
