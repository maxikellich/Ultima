...
var _hoisted_1$1 = ["id", "aria-label", "aria-expanded", "aria-level", "aria-setsize", "aria-posinset"];
      ...
      return openBlock(), createElementBlock(Fragment, {
        ...
        $options.isItemVisible(processedItem) && !$options.getItemProp(processedItem, "separator") ? (openBlock(), createElementBlock("li", mergeProps({
            ...
            !$props.templates.item ? (openBlock(), createElementBlock(Fragment, { key: 0 }, [
              $options.getItemProp(processedItem, "to") && !$options.isItemDisabled(processedItem) ? (openBlock(), createBlock(_component_router_link, {
                ...
                $options.isItemGroup(processedItem) ? (openBlock(), createElementBlock(Fragment, { key: 0 }, [
                  ...
                  }, $options.getPTOptions(processedItem, "submenuIcon")), null, 16, ["active"])) : (openBlock(), createBlock(resolveDynamicComponent($options.isItemActive(processedItem) ? "ChevronDownIcon" : "ChevronRightIcon"), mergeProps({
                    key: 1,
                    class: "p-submenu-icon"
          ...
          createVNode(Transition, { name: "p-toggleable-content" }, {
            default: withCtx(() => [
              withDirectives(createBaseVNode("div", mergeProps({ class: "p-toggleable-content" }, _ctx.ptm("toggleableContent")), [
                $options.isItemVisible(processedItem) && $options.isItemGroup(processedItem) ? (openBlock(), createBlock(_component_PanelMenuSub, {
                  ...
                  pt: _ctx.pt
                }, null, 8, ["id", "panelId", "focusedItemId", "items", "level", "templates", "activeItemPath", "exact", "onItemToggle", "pt"])) : createCommentVNode("", true)
              ], 16), [
      ...
      return openBlock(), createElementBlock(Fragment, {
        ...
        $options.isItemVisible(item) ? (openBlock(), createElementBlock("div", mergeProps({
          ...
          createBaseVNode("div", mergeProps({
            ...
            createBaseVNode("div", mergeProps({ class: "p-panelmenu-header-content" }, $options.getPTOptions(item, "headerContent")), [
                ...
                $options.getItemProp(item, "to") && !$options.isItemDisabled(item) ? (openBlock(), createBlock(_component_router_link, {
                  ...
                  default: withCtx(({ navigate, href, isActive, isExactActive }) => [
                    createBaseVNode("a", mergeProps({
                      ...
                      }, $options.getPTOptions(item, "headerIcon")), null, 16)) : createCommentVNode("", true),
                      createBaseVNode("span", mergeProps({ class: "p-menuitem-text" }, $options.getPTOptions(item, "headerLabel")), toDisplayString($options.getItemLabel(item)), 17)
                    ], 16, _hoisted_3)
                  ]),
                  _: 2
          ...
          createVNode(Transition, { name: "p-toggleable-content" }, {
            default: withCtx(() => [
              withDirectives(createBaseVNode("div", mergeProps({
                ...
                $options.getItemProp(item, "items") ? (openBlock(), createElementBlock("div", mergeProps({
                  key: 0,
