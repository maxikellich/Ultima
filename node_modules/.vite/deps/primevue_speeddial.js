...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock(Fragment, null, [
        ...
        createVNode(_component_SDButton, {
          ...
          icon: withCtx(() => [
            renderSlot(_ctx.$slots, "icon", { visible: $data.d_visible }, () => [
              $data.d_visible && !!$props.hideIcon ? (openBlock(), createBlock(resolveDynamicComponent($props.hideIcon ? "span" : "PlusIcon"), mergeProps({
                key: 0,
                class: $props.hideIcon
              }, _ctx.ptm("button")["icon"]), null, 16, ["class"])) : (openBlock(), createBlock(resolveDynamicComponent($props.showIcon ? "span" : "PlusIcon"), mergeProps({
                key: 1,
          ...
          return openBlock(), createElementBlock(Fragment, { key: index }, [
            $options.isItemVisible(item) ? (openBlock(), createElementBlock("li", mergeProps({
              ...
              !_ctx.$slots.item ? withDirectives((openBlock(), createElementBlock("a", mergeProps({
                ...
                item.icon ? (openBlock(), createElementBlock("span", mergeProps({
                  key: 0,
                  class: ["p-speeddial-action-icon", item.icon]
                }, $options.getPTOptions(`${$data.id}_${index}`, "actionIcon")), null, 16)) : createCommentVNode("", true)
              ], 16, _hoisted_3)), [
    ...
    $props.mask ? (openBlock(), createElementBlock("div", mergeProps({
      key: 0,
