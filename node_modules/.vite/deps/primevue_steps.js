...
var _hoisted_1 = ["id"];
var _hoisted_2 = ["href", "aria-current", "onClick", "onKeydown"];
var _hoisted_3 = ["onKeydown"];
              ...
              !$options.isItemDisabled(item) ? (openBlock(), createBlock(_component_router_link, {
                ...
                default: withCtx(({ navigate, href, isActive, isExactActive }) => [
                  createBaseVNode("a", mergeProps({
                    ...
                    createBaseVNode("span", mergeProps({ class: "p-steps-number" }, _ctx.ptm("step")), toDisplayString(index + 1), 17),
                    createBaseVNode("span", mergeProps({ class: "p-steps-title" }, _ctx.ptm("label")), toDisplayString($options.label(item)), 17)
                  ], 16, _hoisted_2)
                ]),
                _: 2
