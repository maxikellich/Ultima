...
var _hoisted_2 = ["href", "aria-label", "aria-disabled", "tabindex", "onClick", "onKeydown"];
var _hoisted_3 = ["onClick", "onKeydown"];
var _hoisted_4 = ["href", "target", "aria-label", "aria-disabled", "tabindex"];
            ...
            default: withCtx(({ navigate, href, isActive, isExactActive }) => [
              $options.visible(item) ? (openBlock(), createElementBlock("li", mergeProps({
                ...
                !_ctx.$slots.item ? withDirectives((openBlock(), createElementBlock("a", mergeProps({
                  ...
                  }, $options.getPTOptions("icon", i)), null, 16)) : createCommentVNode("", true),
                  createBaseVNode("span", mergeProps({ class: "p-menuitem-text" }, $options.getPTOptions("label", i)), toDisplayString($options.label(item)), 17)
                ], 16, _hoisted_2)), [
                  [_directive_ripple]
