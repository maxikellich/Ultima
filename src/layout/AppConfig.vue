...
<template>
    <Button icon="pi pi-cog" class="layout-config-button" @click="onConfigButtonClick()"></Button>
    ...
    <Sidebar v-model:visible="layoutState.configSidebarVisible.value" position="right" class="layout-config-sidebar w-20rem p-3">
        ...
        <template v-if="!simple">
            ...
            <div class="flex">
                <div class="field-radiobutton flex-1">
                    <RadioButton v-model="layoutConfig.inputStyle.value" name="inputStyle" value="outlined" @change="changeInputStyle('outlined')" inputId="outlined_input"></RadioButton>
                    <label for="outlined_input">Outlined</label>
                </div>
                <div class="field-radiobutton flex-1">
                    <RadioButton v-model="layoutConfig.inputStyle.value" name="inputStyle" value="filled" @change="changeInputStyle('filled')" inputId="filled_input"></RadioButton>
