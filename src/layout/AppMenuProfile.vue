...
<template>
    <div class="layout-menu-profile">
        <button v-tooltip="{ value: tooltipValue('Profile') }" class="p-link" @click="toggleMenu()">
            ...
            <i class="layout-menu-profile-toggler pi pi-fw" :class="{ 'pi-angle-down': layoutConfig.menuProfilePosition === 'start' || isHorizontal, 'pi-angle-up': layoutConfig.menuProfilePosition === 'end' && !isHorizontal }"></i>
        </button>
