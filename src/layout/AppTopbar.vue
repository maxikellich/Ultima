...
<template>
    <div class="layout-topbar">
        <div class="layout-topbar-start">
            ...
            <a ref="menuButton" class="p-ripple layout-menu-button" @click="onMenuButtonClick()" v-ripple>
                <i class="pi pi-chevron-right"></i>
            </a>

            <a ref="mobileMenuButton" class="p-ripple layout-topbar-mobile-button" @click="onMobileTopbarMenuButtonClick()" v-ripple>
                    ...
                    <li class="layout-topbar-search">
                        ...
                        <div class="layout-search-panel hidden p-input-filled">
                            ...
                            <Button
                                ...
                                type="button"
                                icon="pi pi-times"
                                class="p-ripple p-button-rounded p-button-text p-button-plain"
                                v-styleclass="{ selector: '.layout-search-panel', leaveToClass: 'hidden', leaveActiveClass: 'px-fadeout' }"
                            ></Button>
                        </div>
                    </li>
                    <li>
                        ...
                        <div class="hidden">
                            <div class="flex flex-wrap">
                                <div class="w-4 flex flex-column align-items-center p-3">
                                    <Button class="p-button-rounded mb-2" icon="pi pi-image" v-ripple></Button>
                                    <span>Products</span>
                                </div>
                                <div class="w-4 flex flex-column align-items-center p-3">
                                    <Button class="p-button-rounded mb-2 p-button-success" icon="pi pi-file-pdf" v-ripple></Button>
                                    <span>Reports</span>
                                </div>
                                <div class="w-4 flex flex-column align-items-center p-3">
                                    <Button class="p-button-rounded mb-2 p-button-secondary" icon="pi pi-dollar" v-ripple></Button>
                                    <span>Balance</span>
                                </div>
                                <div class="w-4 flex flex-column align-items-center p-3">
                                    <Button class="p-button-rounded mb-2 p-button-warning" icon="pi pi-cog" v-ripple></Button>
                                    <span>Settings</span>
                                </div>
                                <div class="w-4 flex flex-column align-items-center p-3">
                                    <Button class="p-button-rounded mb-2 p-button-help" icon="pi pi-key" v-ripple></Button>
                                    <span>Credentials</span>
                                </div>
                                <div class="w-4 flex flex-column align-items-center p-3">
                                    <Button class="p-button-rounded mb-2 p-button-info" icon="pi pi-sitemap" v-ripple></Button>
                                    <span>Sitemap</span>
                                </div>
                            </div>
                        </div>
