...
function onChatKeydown(event) {
    if (event.key === 'Enter') {
        ...
        if (lastMessage.from) {
            chatMessages.value.push({ messages: [message] });
        } else {
            lastMessage.messages.push(message);
        }

        if (message.match(/primeng|primereact|primefaces|primevue/i)) {
            chatMessages.value.push({ from: 'Ioni Bowcher', url: '/demo/images/avatar/ionibowcher.png', messages: ['Always bet on Prime!'] });
        }
...
function getOverviewColors() {
    const isLight = layoutConfig.layoutMode === 'light';
    return {
    ...
    <div class="grid">
        <div class="col-12 md:col-6 lg:col-3">
            <div class="card flex flex-column">
                <div class="flex align-items-center text-gray-700">
                    ...
                    <div class="ml-auto">
                        <Button v-ripple icon="p-riple pi pi-ellipsis-h" class="p-button-rounded p-button-text" @click="toggleMenu"></Button>
        ...
        <div class="col-12 md:col-6 lg:col-3">
            <div class="card flex flex-column">
                <div class="flex align-items-center text-gray-700">
                    ...
                    <div class="ml-auto">
                        <Button v-ripple icon="pi pi-ellipsis-h" class="p-button-rounded p-button-text" @click="toggleMenu"></Button>
        ...
        <div class="col-12 lg:col-6">
            <div class="card h-full">
                ...
                <Chart type="line" :data="ordersChart" :options="ordersOptions" :width="300"></Chart>
            </div>
        </div>
        ...
        <div class="col-12 md:col-12 lg:col-6">
            <div class="card h-full">
                <DataTable :value="products" :paginator="true" :rows="8" :tableStyle="{ 'min-width': '40rem' }">
        ...
        <div class="col-12 lg:col-6">
            <div class="card h-full">
                ...
                <div>
                    <ul class="m-0 px-3 pt-3 pb-0 border-none list-none h-30rem overflow-y-auto outline-none" ref="chatcontainer">
                        <li
                    ...
                    <div class="p-inputgroup mt-3">
                        <span class="p-inputgroup-addon p-0 overflow-hidden border-round-3xl border-noround-right">
                            <Button v-ripple icon="pi pi-plus-circle" class="p-button-text p-button-plain h-full"></Button>
                        </span>
                        ...
                        <span class="p-inputgroup-addon p-0 overflow-hidden">
                            <Button v-ripple icon="pi pi-video" class="p-button-text p-button-plain h-full"></Button>
                        </span>
                        <span class="p-inputgroup-addon p-0 overflow-hidden border-round-3xl border-noround-left">
                            <Button v-ripple icon="pi pi-clock" @click="toggleEmojis" class="p-button-text p-button-plain h-full"></Button>
                            <OverlayPanel ref="op" class="emoji" appendTo="body" style="width: 45em">
                                <Button type="button" v-for="emoji in chatEmojis" :key="emoji" @click="onEmojiOverlayPanel(emoji)" :label="emoji" class="emoji-button p-2 p-button-text p-button-plain"></Button>
                            </OverlayPanel>
                        </span>
                    </div>
                </div>
