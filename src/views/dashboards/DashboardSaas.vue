                    ...
                    <div class="flex aling-items-center justify-content-between mb-3">
                        <div class="flex gap-3 flex-column justify-content-between w-full md:flex-row md:align-items-center">
                            ...
                            <div class="flex align-items-center gap-2">
                                <Button label="Enroll a Ticket" icon="pi pi-send" class="p-button-outlined"></Button>
        ...
        <div class="col-12 md:col-4">
            <div class="h-full bg-primary flex justify-content-between align-items-center pl-5 py-3 border-round-md overflow-hidden">
                <div class="flex flex-column justify-content-center">
                    ...
                    <div>
                        <Button icon="pi pi-database" label="See All Plans" class="p-button-outlined bg-white mt-3"></Button>
                    </div>
                </div>
                        ...
                        <div class="col-12 md:col-4">
                            <div class="flex flex-column gap-3 border-round-md border-1 h-full surface-border py-4">
                                <div class="flex justify-content-between align-items-center mx-4">
                                    ...
                                    <div>
                                        <Button v-ripple icon="pi pi-plus" label="New Task" class="p-button-outlined"></Button>
                                    </div>
                                </div>
                                        ...
                                        <div class="flex gap-3">
                                            <div class="flex align-items-end">
                                                <AvatarGroup>
                                                    ...
                                                    <Avatar label="+2" shape="circle" style-class="surface-200 text-color-secondary"></Avatar>
                                                </AvatarGroup>
                                            </div>
                        ...
                        <div class="col-12 md:col-4">
                            <div class="flex flex-column gap-3 border-round-md border-1 h-full surface-border p-4">
                                ...
                                <div class="flex flex-column gap-2 h-21rem -mb-4 relative">
                                    <Chart :height="195" type="line" :data="basicData" :options="basicOptions"></Chart>
                                </div>
                            </div>
                        </div>
                        <div class="col-12 md:col-4">
                            <div class="flex flex-column gap-3 border-round-md border-1 h-full surface-border py-4">
                                <div class="flex justify-content-between align-items-center mx-4">
                                    ...
                                    <div class="flex align-items-center gap-1">
                                        <Button v-ripple icon="pi pi-filter" class="p-button-outlined"></Button>
                                        <Button v-ripple icon="pi pi-plus" class="p-button-outlined"></Button>
                                    </div>
                                </div>
                                <div class="flex flex-column gap-2 h-21rem overflow-auto -mb-4">
                                    <div
            ...
            <div class="card flex justify-content-between align-items-center">
                <div class="p-2 h-full w-full flex flex-column justify-content-between">
                    <div class="flex align-items-center justify-content-between mb-3">
                        ...
                        <div class="flex align-items-center gap-2">
                            <Button v-ripple label="Organize Teams" icon="pi pi-sliders-h" class="p-button-outlined"></Button>
                            <Button v-ripple label="New Project" icon="pi pi-plus-circle"></Button>
                        </div>
                    </div>
                    <div class="grid">
                        ...
                        <div class="col-12 md:col-4">
                            <div class="border-1 surface-border p-3 border-round-md flex flex-column gap-3">
                                <div class="flex justify-content-between align-items-center">
                                    ...
                                    <Button v-ripple label="New Team" icon="pi pi-users"></Button>
                                </div>
                                <div class="flex flex-column gap-1">
                                    <div
                                        v-for="team in teams"
                                    ...
                                    >
                                        ...
                                        <div class="flex gap-2 align-items-center">
                                            <AvatarGroup>
                                                ...
                                                <Avatar v-if="team.avatarText" :label="team.avatarText" shape="circle" style-class="surface-200 text-color-secondary" :style="{ color: '#ffffff' }"></Avatar>
                                            </AvatarGroup>
                                ...
                                <div v-for="member in filteredTeamMembers" :key="member.avatar" class="grid grid-nogutter align-items-center p-2 border-bottom-1 surface-border text-700 cursor-pointer hover:text-color">
                                    ...
                                    <div class="col-2">
                                        <div class="flex justify-content-end">
                                            <Button class="p-button-text p-button-rounded text-900" icon="pi pi-ellipsis-h"></Button>
                                        </div>
                                    </div>
                                </div>
                            </div>
