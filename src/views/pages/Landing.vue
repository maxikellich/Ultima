        ...
        <div style="height: 68px; backdrop-filter: blur(17px)" class="flex justify-content-between align-items-center z-3 px-5 bg-black-alpha-40 top-0 w-full fixed">
            ...
            <div id="menu" class="align-items-center flex-grow-1 hidden lg:flex absolute lg:static w-full lg:px-0 z-3 shadow-2 lg:shadow-none fadein" style="top: 68px; right: 0%">
                <ul class="list-none p-3 lg:p-0 m-0 ml-auto flex lg:align-items-center select-none flex-column lg:flex-row cursor-pointer surface-0 lg:bg-transparent">
                    ...
                    <li>
                        <Button v-ripple label="LET'S TRY" class="surface-900 text-0 m-0 mt-3 md:mt-0 md:ml-5"></Button>
                    </li>
                </ul>
            </div>
        </div>
        <div class="h-screen">
            <div style="perspective: 101px" class="h-screen overflow-x-hidden overflow-y-auto absolute top-0 left-0 right-0 bottom-0">
                <div class="hidden lg:block absolute top-0 right-0 bottom-0 left-0 parallax__layer__0">
                    <img :draggable="false" src="/layout/images/landing/layer-0-opt.jpg" class="w-full h-full block absolute bottom-0" />
                </div>
                <div class="hidden lg:block absolute top-0 right-0 bottom-0 left-0 parallax__layer__1">
                    <img :draggable="false" src="/layout/images/landing/layer-1-opt.png" class="w-full block absolute bottom-0" />
                </div>
                ...
                <div class="hidden lg:block absolute top-0 right-0 bottom-0 left-0 parallax__layer__2">
                    <img :draggable="false" src="/layout/images/landing/layer-2-opt.png" class="w-full block absolute bottom-0" />
                </div>
                ...
                <div class="absolute flex justify-content-center align-items-center w-full h-full parallax__layer__3" style="top: 112px">
                    <Button
                        ...
                        class="p-button-text text-900 bg-white-alpha-20 text-lg px-5 py-3 font-semibold hover:bg-white hover:text-0 border-round-xl border-white-alpha-30 border-1"
                    ></Button>
                </div>

                <div class="block lg:hidden h-28rem bg-center bg-no-repeat bg-cover" style="top: 68px; background: url(/layout/images/landing/landing-hero-image.jpg)">
                        ...
                        <div class="flex flex-column">
                            ...
                            <div class="flex justify-content-center mt-2">
                                <Button
                                    ...
                                    style="backdrop-filter: blur(7px)"
                                    class="p-button-text text-900 text-xs bg-white-alpha-20 font-semibold hover:bg-white hover:text-0 border-white-alpha-30 border-1"
                                ></Button>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="flex flex-column align-items-center">
                            ...
                            <div ref="video" style="max-width: 1200px" class="flex gap-4 mt-6 py-6 flex-column align-items-center w-full">
                                ...
                                <div class="mt-3 relative">
                                    ...
                                    <div class="absolute z-0" style="top: -50px; left: -50px"><img :draggable="false" class="opacity-40" src="/layout/images/landing/landing-ellipse.png" alt="" /></div>
                                    <div class="absolute z-0" style="bottom: -50px; right: -50px; filter: blur(4px)"><img :draggable="false" class="opacity-40" src="/layout/images/landing/landing-ellipse2.png" alt="" /></div>
                                    <div class="absolute z-0" style="bottom: -50px; right: 10px; filter: blur(4px)"><img :draggable="false" class="opacity-40" src="/layout/images/landing/landing-ellipse2.png" alt="" /></div>
                                </div>
                            </div>
                            <div class="py-6 px-4 mt-6 w-full flex justify-content-center">
                                ...
                                >
                                    ...
                                    <div class="flex align-items-center gap-2">
                                        ...
                                        <Button class="p-button-text text-white border-1 border-white border-round-md h-full" label="JOIN"></Button>
                                    </div>
                                </div>
                            </div>
