        ...
        <div class="flex flex-1 flex-column surface-ground align-items-center justify-content-center">
            <div class="w-11 sm:w-30rem">
                ...
                <div class="flex flex-column gap-3 mt-6">
                    ...
                    <div>
                        <Button @click="navigateToDashboard" class="w-full" label="LOGIN"></Button>
                    </div>
                    <div>
                        <Button class="w-full p-button-text text-primary-500" label="FORGOT PASSWORD?"></Button>
                    </div>
                </div>
            </div>
        </div>
        <div :style="{ backgroundImage: 'url(/layout/images/pages/accessDenied-bg.jpg)' }" class="hidden lg:flex flex-1 align-items-center justify-content-center bg-cover">
