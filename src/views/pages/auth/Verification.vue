            ...
            <div class="w-11 sm:w-30rem">
                <div class="flex flex-column">
                    ...
                    <div class="mt-4">
                        ...
                        <span class="block text-700 mt-2">Verify your code</span>
                    </div>
                </div>
                ...
                <div class="mt-3">
                    <Button v-ripple class="w-full" label="VERIFY NOW"></Button>
                </div>
                <div class="mt-3">
                    <Button v-ripple class="w-full p-button-text text-primary-500" label="SEND AGAIN"></Button>
                </div>
            </div>
        </div>
